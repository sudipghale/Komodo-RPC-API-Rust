...
pub fn main() {
	...
	let someUser = KomodoRPC::new(someAddress, somePortNum, someReqMethod,someUserName, somePassword, someAuth, someReqURL, someReqHeader, 
...
//getaddressbalance
let get_address_balance=komodo::address::getaddressbalance(someUser,["RTTg3izdeVnqkTTxjzsPFrdUQexgqCy1qb".to_string()].to_vec()); 
